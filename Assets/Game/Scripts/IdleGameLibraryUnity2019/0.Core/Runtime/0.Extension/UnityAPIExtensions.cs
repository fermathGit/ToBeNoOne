...
namespace QFramework
{
    ...
    public static class RectTransformExtension
    {
        ...
        public static RectTransform SetAnchoredPosX( this RectTransform selfRectTrans, float posX ) {
            var anchoredPosition = selfRectTrans.anchoredPosition;
            anchoredPosition.x = posX;
            selfRectTrans.anchoredPosition = anchoredPosition;
            return selfRectTrans;
        }

        public static RectTransform SetAnchoredPosY( this RectTransform selfRectTrans, float posY ) {
            var anchoredPosition = selfRectTrans.anchoredPosition;
